var helpers = {
  skills1 : [
    ...
    { image_url: "images/rails.png", name: "Ruby on Rails", level: "90%",
  ...
  skills2 : [
    ...
    { image_url: "images/vim.png", name: "Vim", level: "90%",
...
window.onload = function() {
  ...
  ['skills1', 'skills2', 'skills3'].forEach(function(name) {
    helpers[name].forEach(function(skill) {
      var html = template(skill);
      $("#" + name).append(html);
    })
  })
  ...
  helpers.projects.forEach(function(skill) {
    var html = template(skill);
    $("#projects-placeholder").append(html);
  })
};
